...
const ProjectList = () => {
  ...
  return <>
    <Tooltip label={<>"Don't write something <Text
      ...
      openDelay={3000}
    >
      <TextInput mt={10} placeholder='Search...' label="Search for projects" type='search' onChange={e => setSearch(e.target.value)} />
    </Tooltip>
    <Space h={15} />
    ...
    {!filteredProjects.length &&(
      search.toLocaleLowerCase() === "sus" ? "" : <Text w={"100%"} ta={"center"}>There's nothing I can show you 3:</Text>
    )}
  </>;
};
